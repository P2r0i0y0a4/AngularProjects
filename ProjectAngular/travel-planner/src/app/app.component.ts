...
export class AppComponent {
  ...
  navItems = [
    ...
    { path: '/trips', icon: '🗺️', label: 'Trip Planner',badge: 'new' },
    { path: '/timeline', icon: '📅', label: 'Timeline',badge: '' },
    { path: '/budget', icon: '💰', label: 'Budget',badge: '' },
    { path: '/packing', icon: '🧳', label: 'Packing List',badge: '' },
    { path: '/weather', icon: '🌤️', label: 'Weather',badge: '' },
    { path: '/compare', icon: '⚖️', label: 'Compare Trips' ,badge: ''},
    { path: '/explore', icon: '🔭', label: 'Explore',badge: '' },
    { path: '/profile', icon: '👤', label: 'Profile',badge: '' },
  ];
